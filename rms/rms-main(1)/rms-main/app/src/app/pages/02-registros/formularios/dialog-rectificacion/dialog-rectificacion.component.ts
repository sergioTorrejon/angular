...
@Component({
  selector: 'app-dialog-rectificacion',
  templateUrl: './dialog-rectificacion.component.html',
  styleUrls: ['./dialog-rectificacion.component.css'],
  providers: [
...
export class DialogRectificacionComponent implements OnInit  {
  ...
  (
    ...
    private dialogRef: MatDialogRef<DialogRectificacionComponent>,
